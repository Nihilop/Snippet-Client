<template>
  ...
  <div class="home" v-else>
    <transition name="drop-top">
      <n-result class="welcome" status="404" title="Aucune donnée" description="Selectionner un projet ou créer en un" size="huge">
        <template #footer>
          <n-button @click="addProject = true">Créer un projet</n-button>
        </template>
      </n-result>
    </transition>
...
import { useNotification, NH1, NThing, NSpace, NIcon, NButton, NAvatar, NResult, NModal, NCard, NLayout, NBlockquote } from 'naive-ui'
